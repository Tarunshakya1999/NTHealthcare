          ...
          <div className="pp-card">
            ...
            <div className="pp-section-body">
              ...
              <div
                ...
                style={{ borderRadius: 12, margin: "16px 0 14px" }}
              >
                <span style={{ fontSize: "0.8rem", fontWeight: 800, color: "#fff" }}>
                  ℹ️ How to Pay / भुगतान कैसे करें
                </span>
              </div>

              <div className="pp-steps">
                {[
                  ["Scan the QR Code above",            "QR कोड स्कैन करें"],
                  ["Complete payment in your UPI app",  "UPI ऐप से भुगतान पूरा करें"],
                  ["Take a screenshot of success screen","सफलता का स्क्रीनशॉट लें"],
                  ["Fill the order form below & submit", "नीचे फॉर्म भरें और सबमिट करें"],
                ].map(([en, hi], i) => (
                  <div className="pp-step" key={i}>
                    <div className="pp-step-num">{i + 1}</div>
                    <div className="pp-step-text">
                      <strong>{en}</strong>
                      <span className="pp-hindi">{hi}</span>
                    </div>
                  </div>
                ))}
              </div>

              {/* WhatsApp button — ✅ <a> tag properly closed */}
              <div className="pp-divider" style={{ marginTop: 20 }}>
                <span>also send screenshot / स्क्रीनशॉट भेजें</span>
              </div>

              
                <a href={`https://wa.me/917011617976?text=${encodeURIComponent(waMessage)}`}
                target="_blank"
